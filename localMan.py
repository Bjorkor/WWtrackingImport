...
def scrape():
    ...
    #megaZord = pd.merge(left=localMansPants, right=orderMansPants, how='left', on='increment_id')
    #print(megaZord)
    #print(localMansPants.dtypes)
    print(localMansPants.astype({'increment_id': str}, errors='ignore').astype({'increment_id': int}, errors='ignore').dtypes)
scrape()