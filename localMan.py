...
def scrape():
    ...
    localMansPants2['increment_id'] = localMansPants2['increment_id'].astype('int', errors='ignore')
    orderMansPants2['increment_id'] = orderMansPants2['increment_id'].astype('int', errors='ignore')
