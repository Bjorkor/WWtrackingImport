...
def scrape():
    ...
    localMansPants = localMansPants.astype({'increment_id': 'float'}, errors='ignore', copy=False)
    orderMansPants = orderMansPants.astype({'increment_id': 'float'}, errors='ignore', copy=False)
